...
var NoSuchElementError = exports.NoSuchElementError = function() {
 ...
 * Other errors
 */
var NoCurrentStateError = exports.NoCurrentStateError = function() {
	BaseError.apply(this, arguments);
	this.name = 'NoCurrentStateError';
	this.message = 'Before state operation (e.g. wait for state change) ' +
		'current state must be saved first.';
};
inherits(NoCurrentStateError, BaseError);
