...
WebDriver.prototype.execCommand = function(params, callback) {
	...
	var req = request(requestParams, function(err, res) {
		...
		// chaining)
		callback(null, params.resNeeded ? res : res.data && res.data.value || self);
	});
};
...
WebDriver.prototype.deleteSession = function() {
	this.execCommand({
		path: '',
		method: 'DELETE'
	});
...
WebDriver.prototype.get = function(params) {
...
var queryRegExp = /\?.*$/;
WebDriver.prototype.waitForRedirect = function(url) {
	this.waitFor({
		func: function(url) {
...
WebDriver.prototype.waitForUrlChange = function(oldUrl) {
	this.waitFor({
		func: function(url) {
...
WebDriver.prototype.waitFor = function(params) {
