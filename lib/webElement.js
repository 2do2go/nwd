...
var createJqueryNameMethod = function(method) {
	return function() {
 ...
 * @param {Function} callback(err:Error,value:String)
 */
WebElement.prototype.attr = createJqueryNameMethod('attr');
 ...
 */
WebElement.prototype.prop = createJqueryNameMethod('prop');
 ...
 * @param {Function} callback(err:Error,value:String)
 */
WebElement.prototype.css = createJqueryNameMethod('css');
 ...
 * @param {Function} callback(err:Error,text:String)
 */
WebElement.prototype.text = createJqueryNameMethod('text');
